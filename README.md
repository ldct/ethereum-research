...
Yes, this list contains "ethereum" in the title, but we can't ignore the OG cryptocurrency. Read this to understand
...
The paper also discusses the following; feel free to skim them on a first read.

- The UTXO abstraction
- SPV client vs Full Node

Final note: the diagram on page 2 is quite confusing, I like Joao Batalha's clarification at https://fermatslibrary.com/s/bitcoin

## Ethereum White Paper

https://github.com/ethereum/wiki/wiki/White-Paper

Describes ethereum. Also describes Bitcoin at about the same level of detail as Satoshi's paper, but with a slightly different abstraction, which might help you get some confusing concepts. Read this to understand

- What smart contracts are and why they might be useful
- The EVM, accounts and storage

 It also has some anciliary mostly-orthogonal technical details which you should skim or skip for now:
...
## "Fraud-Proof" / "Interactive Verification" based off-chain scaling
